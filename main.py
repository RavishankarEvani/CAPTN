...
import dataloader
from src.loss import LatentTextureAttributeLoss
...
cs.store(name='graph_texture_net_config', node=CAPTNConfig)
...
def setup(
    ...
    Args:
        cfg (CAPTNConfig): Configuration object containing various experimental settings.

    Returns:
        CAPTNConfig: Updated configuration object based on CUDA availability.
    """
...
def main(
    ...
    Args:
        cfg (CAPTNConfig): Configuration object containing all the necessary 
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        criterion = LatentTextureAttributeLoss(cfg = cfg, 
